...
[
  {
    "url": "articles/ekonomika-razvilka.html",
    "title": "Российская экономика подходит к развилке",
    "description": "Анализ текущего состояния российской экономики и возможных сценариев развития на фоне глобальных вызовов",
    "date": "19 июля 2025",
    "tags": ["экономика", "инфляция", "Центральный банк"]
  },
  {
    "url": "articles/millions-za-chas.html",
    "title": "Трейдер из России заработал $1 млн за неделю",
    "description": "Российский трейдер Кайя Патрушев получил почти $1 млн прибыли менее чем за неделю, инвестировав в криптовалюту Chainlink в блокчейне Solana",
    "date": "21 января 2024",
    "tags": ["экономика", "криптовалюты", "Кайя Патрушев"]
  },
